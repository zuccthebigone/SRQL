...
const kippy_1 = require("./core/kippy");
const parse_1 = require("./core/parse");
const peer_1 = require("./core/peer");
const electron_1 = require("electron");
const client_factory = new db_1.ClientFactory();
class WindowFrame extends kippy_1.Kippy {
    constructor() {
    ...
    initialise() {
        ...
        this.passwordHash = security_1.hashPassword("password123");
    ...
    authenticate(username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield security_1.authenticate(username, password);
            this.state.authenticated = user !== null;
            if (this.state.authenticated) {
                this.userId = user.id;
                this.username = username;
                this.peer = new peer_1.Peer(this.username);
...
class TitleBar extends kippy_1.Kippy {
    constructor(parent) {
        super(parent, "div", "title-bar");
    }
    initialise() {
        this.window = electron_1.BrowserWindow.getFocusedWindow();
...
class SrqlSearch extends kippy_1.Kippy {
    constructor(parent) {
...
class SearchSuggestion extends kippy_1.Kippy {
    constructor(parent) {
...
class LoginBox extends kippy_1.Kippy {
    constructor(parent) {
...
class Sidebar extends kippy_1.Kippy {
    constructor(parent) {
...
class View extends kippy_1.Kippy {
...
class SrqlTiles extends kippy_1.Kippy {
    constructor(parent) {
    ...
    update() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.root.state.authenticated) {
                ...
                this.srqls = [];
                const client = yield client_factory.new();
                const { rows, } = yield client.query(`SELECT id FROM srql s INNER JOIN srql_member sm ON s.id=sm.srql_id WHERE sm.user_id=$1::uuid`, [this.root.user_id]);
                rows.forEach((srql) => {
...
class SrqlTile extends kippy_1.Kippy {
...
class Chat extends kippy_1.Kippy {
    constructor(parent) {
    ...
    set text(text) {
        this.container.innerHTML = "";
        this.chat = parse_1.parseChat(text);
...
class ChatInput extends kippy_1.Kippy {
    constructor(parent) {
...
//# sourceMappingURL=kippy-elements.js.map